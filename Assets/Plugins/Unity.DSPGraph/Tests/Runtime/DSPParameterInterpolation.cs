            ...
            }))
            {
                ...
                for (int sampleOffset = 0; sampleOffset < 10; ++sampleOffset)
                    Assert.AreEqual(value[0],
                        DSPParameterInterpolator.Generate(sampleOffset, *setup.Graph.ParameterKeys.UnsafeDataPointer,
                            newKeyIndex, dspClock, float.MinValue, float.MaxValue, value)[0], 0.001f);
            }
        }
    }
}
