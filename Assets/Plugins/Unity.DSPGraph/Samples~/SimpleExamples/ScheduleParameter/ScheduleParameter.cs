    ...
    public class ScheduleParameter : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            using (var block = m_Graph.CreateCommandBlock())
            {
                ...
                {
                    block.SetFloat<StateVariableFilter.AudioKernel.Parameters, StateVariableFilter.AudioKernel.Providers
                                   , StateVariableFilter.AudioKernel>(m_LowPass, StateVariableFilter.AudioKernel.Parameters.Cutoff,
                            newCutoff);
                    Cutoff = newCutoff;
                }
                ...
                {
                    block.SetFloat<StateVariableFilter.AudioKernel.Parameters, StateVariableFilter.AudioKernel.Providers
                                   , StateVariableFilter.AudioKernel>(m_LowPass, StateVariableFilter.AudioKernel.Parameters.Q,
                            newq);
                    Q = newq;
                }
                ...
                {
                    block.SetFloat<StateVariableFilter.AudioKernel.Parameters, StateVariableFilter.AudioKernel.Providers
                                   , StateVariableFilter.AudioKernel>(m_LowPass,
                            StateVariableFilter.AudioKernel.Parameters.GainInDBs, newGain);
                    Gain = newGain;
                }
            }
        }
